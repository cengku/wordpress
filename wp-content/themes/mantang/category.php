...
<section class="hero-section" style="background-image: url('<?php echo esc_url( $hero_image ); ?>');">
    ...
    <div class="hero-body">
        <h1 class="hero-title"><?php echo esc_html( $cat_name ); ?></h1>
        <?php if ( $cat_desc ) : ?>
        <p class="hero-subtitle"><?php echo esc_html( wp_strip_all_tags( $cat_desc ) ); ?></p>
        <?php endif; ?>
        <div class="hero-divider"></div>
        <a href="#blog-list" class="hero-btn">探索更多</a>
    </div>
...
<section id="blog-list" class="blog-list-section">
    <div class="section-header">
        <h2 class="section-title"><?php echo esc_html( $cat_name ); ?></h2>
    </div>
    <div class="post-list">
        <?php
        $index = 0;
        ...
        <article class="post-card <?php echo $is_odd ? 'post-card--odd' : 'post-card--even'; ?>">
            ...
            <div class="post-card__info">
                <span class="post-card__cat"><?php echo esc_html( $post_cat ); ?></span>
        ...
        ?>
        <p style="text-align:center;color:#888;">该分类下暂无文章</p>
        <?php endif; ?>
    </div>
